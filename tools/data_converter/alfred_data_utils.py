...
class AlfredData(object):
    ...
    def __init__(self, root_path, split='train'):
        ...
        if split == 'train':
            ...
            mmcv.check_file_exist(split_file1)
            split_file2 = osp.join(self.root_dir, 'meta_data/valid_unseen.txt')
            mmcv.check_file_exist(split_file2)
            self.sample_id_list = mmcv.list_from_file(
                split_file1) + mmcv.list_from_file(split_file2)
            self.test_mode = True
        elif split == 'test':
